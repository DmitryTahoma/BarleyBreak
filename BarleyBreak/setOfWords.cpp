...
{		
	...
	sets[0][34] = "Congratulations on your victory!";
	// en
	// RU
	sets[1][0] = "Новая игра";
	sets[1][1] = "Настройки";
	...
	sets[1][34] = "Поздравляем с победой!";
	// ru
	// UA
	sets[2][0] = "Нова гра";
	sets[2][1] = "Налаштування";
	...
	sets[2][9] = "Назад в головне меню";
	sets[2][10] = "Оберіть налаштування, які потрібно змінити";
	sets[2][11] = "Чорний";
	sets[2][12] = "Синій";
	sets[2][13] = "Зелений";
	sets[2][14] = "Голубий";
	...
	sets[2][34] = "Вітаємо із перемогою!";
	// ua
}
